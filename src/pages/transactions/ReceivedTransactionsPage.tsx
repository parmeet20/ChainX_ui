...
import { getAllMyReceivedTransactions } from "@/services/transactions/transactionService";
...
const ReceivedTransactionsPage = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      ...
      const t = await getAllMyReceivedTransactions(program, publicKey);
      setTransactions(t);
    };
    fetchTransactions();
  }, [program, publicKey]);
